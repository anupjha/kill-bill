...
import RobotoRegular from "../styles/Roboto/Roboto-Regular.ttf";
import RobotoBold from "../styles/Roboto/Roboto-Bold.ttf";
import RobotoItalic from "../styles/Roboto/Roboto-Italic.ttf";
...
Font.register({
  ...
  fonts: [
    ...
    { src: RobotoItalic, fontWeight: "light" },
  ],
});
...
const InvoicePage = ({ data, pdfMode, onChange }) => {
  ...
  const invoiceDueDate =
    invoice.invoiceDueDate !== "" ? new Date(invoice.invoiceDueDate) : new Date(invoiceDate.valueOf());
            ...
            <View className="flex mb-5" pdfMode={pdfMode}>
              ...
              <View className="w-60" pdfMode={pdfMode}>
                <EditableCalendarInput
                  ...
                  onChange={(date) =>
                    handleChange("invoiceDueDate", date && !Array.isArray(date) ? format(date, dateFormat) : "")
                  }
                  pdfMode={pdfMode}
                />
              </View>
            ...
            <View className="flex bg-gray p-5" pdfMode={pdfMode}>
              ...
              <View className="w-50 p-5 flex" pdfMode={pdfMode}>
                ...
                <Text className="right bold dark w-auto" pdfMode={pdfMode}>
                  {(typeof subTotal !== "undefined" && typeof saleTax !== "undefined" ? subTotal + saleTax : 0).toFixed(
                    2
                  )}
                </Text>
              </View>
